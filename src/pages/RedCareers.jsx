        ...
        <div className="overflow-hidden">
                ...
                <div>
                    <div className="flex lg:flex-row flex-col-reverse w-full">
                        <div className=" flex-1 flex-col flex items-center justify-center h-[430px]">
                            <div>
                                <div className="lg:h-[156px] h-[350px] w-[347px] lg:w-full">
                                    <h2 className="lg:text-[40px] text-[24px] lg:w-[494px] w-[267px] lg:h-[88px] lg:leading-[44px] leading-[32px] font-semibold mb-2">Investing in You<br />(We are Interested in You)</h2>
                        ...
                        <div className="flex-1 flex-col flex lg:items-center justify-center lg:h-[430px]">
                            <div className="pl-4 lg:pl-0">
                                <div className="lg:h-[156px] h-[350px] w-[200px] lg:w-full">
                                    ...
                                    <p className="lg:w-[500px] w-[347px] text-[16px] leading-[20px] font-medium text-[#56575D] mt-4">
            ...
            <section>
                <div className="bg-black w-full lg:h-[1169px] h-[400px] lg:p-20">
                    <div className="lg:w-[1280px] w-full lg:h-[1008px] h-[400px] flex flex-row py-8 lg:py-0 lg:flex-col gap-6 overflow-x-scroll lg:overflow-hidden">
