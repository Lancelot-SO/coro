...
const Marine = () => {
    ...
    return (
        <div className="overflow-hidden">
            ...
            <section>
                <div className="w-full lg:h-[300px] h-[220px] bg-black lg:px-28 px-4 items-center lg:py-20 py-10">
                    ...
                    <div className="flex lg:flex-row flex-col-reverse w-full">
                        <div className=" flex-1 flex-col bg-[#EFEFF0] flex items-center justify-center lg:h-[430px] h-[500px]">
                            <div className="p-4 lg:p-0">
                                <div className="lg:h-[156px] h-[160px] ">
                                    <h2 className="lg:text-[32px] text-[20px] lg:leading-[40px] leading-[24px] font-semibold">HOMEOWNERS</h2>
                                    <p className="lg:w-[560px] w-full lg:text-[16px] text-[12px] leading-[20px] font-medium text-[#56575D] mt-4">
            ...
            <section>
                <div className="flex lg:flex-row flex-col-reverse w-full mb-8 lg:mb-0">
                    ...
                    <div className="flex-1 relative flex items-end justify-end">
                        ...
                        <img
                            ...
                            className="bg-cover w-[354px] lg:w-[628px] lg:h-[400px] h-[302px] absolute lg:top-[100px] top-[10px] right-[90px] lg:right-[150px]"
                            loading="lazy" />
                    </div>
                </div>
            </section>
