    ...
    return (
        <div className="overflow-hidden">
                    ...
                    <div className="flex lg:flex-row flex-col gap-6 lg:w-[1280px] h-full">
                        <div className="lg:w-[627px] w-[347px] lg:h-[770px] h-[690px] p-4 border border-b-4 border-b-[#FF0226] bg-white rounded-lg shadow-lg">
                            ...
                            <div>
                                ...
                                <div onClick={() => setIsModalOpen(true)} className="w-[142px] h-[36px] bg-[#F7F7F8] font-semibold lg:text-[14px] text-[12px] leading-[20px] cursor-pointer shadow-md text-black flex items-center justify-center lg:mt-32 mt-4">
                                    Insurance Features
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-[627px] w-[347px] lg:h-[770px] h-[750px] p-4 border border-b-4 border-b-[#FF0226] bg-white rounded-lg shadow-lg">
                            <img
                                src={hero2} alt="hero"
                                className="lg:w-full w-[343px] lg:h-[280px] h-[220px] rounded-lg bg-cover"
                                loading="lazy" />
            ...
            <section>
                <div className="flex lg:flex-row flex-col lg:mt-40 mt-0 lg:px-28 px-0 lg:gap-10 gap-6">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <div className="lg:w-[467px] w-[375px] lg:h-[328px] h-[400px] px-4 lg:px-0">
                            <h3 className="w-full lg:h-[40px] h-[28px] font-semibold lg:text-[32px] text-[20px] lg:leading-[40px] leading-[28px] mt-2">
                                Machinery Breakdown
                            </h3>
                            <p className="mt-2">
            ...
            <section>
                <div className="flex lg:flex-row flex-col lg:mt-40 mt-0 lg:px-28 px-0 lg:gap-10 gap-6">
                    <div>
                        <img src={engineer6} alt="engineer" className="w-[628px] h-[452px]" />
                    </div>
                    <div className="flex flex-col items-center">
                        <div className="lg:w-[467px] w-[375px] lg:h-[328px] h-[430px] px-4 lg:px-0 mt-4 lg:mt-0">
            ...
            <section>
                <div className="lg:p-20 p-4 small:p-10">
                    <div className="w-full lg:h-[450px] h-[900px]">
                        ...
                        <div className="flex lg:flex-row flex-col lg:gap-4 gap-8 lg:mt-4 mt-10">
                            <div className="flex-1 flex flex-col lg:h-[350px] h-[600px] w-[347px] gap-4 bg-white border-4 border-t-1 border-x-0 border-b-[#FF0226] rounded-lg shadow-md p-4">
