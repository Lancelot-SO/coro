...
const RedMotor = () => {
    ...
    return (
        <div className="overflow-hidden">
                ...
                <div className="flex lg:flex-row flex-col-reverse w-full lg:h-[450px] h-[678px] ">
                    <div className="flex-1 flex-col bg-[#EFEFF0] flex lg:items-center justify-center">
                        <div className="p-4">
                            ...
                            <p className="lg:w-[560px] w-[319px] lg:text-[16px] text-[12px] leading-[20px] font-medium text-[#56575D] lg:mt-4 mt-2">
                                This is an insurance product that pays for damages to your vehicle (private or commercial) as a result of theft,
                                accident or fire. It also covers third-party injury and death, property damage and legal cost.
                                It comes in 3 variants namely Third Party, Third Party, Fire and theft & Comprehensive.
                            </p>
                        </div>
                    </div>
            ...
            <section>
                <div className="w-full h-[290px] bg-black lg:px-28 px-4 items-center lg:py-20 py-10">
            ...
            <section>
                <div className="relative overflow-hidden">
                    <img src={motorfeature} alt="feature" className="h-[657px] object-cover" loading="lazy" />
                    <div className="absolute lg:top-[20%] top-[15%] lg:left-[20%] left-5 lg:w-[954px] w-[350px] bg-white border rounded-lg shadow-md">
                        <div className="p-4">
                                ...
                                {isExpanded.comprehensive && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <span onClick={() => setIsModalOpen(true)} className="w-[142px] h-[36px] bg-[#FF0226] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-white flex items-center justify-center mt-6">
                                                Insurance Features
                                            </span>
                            ...
                            <div className="mb-4">
                                ...
                                {isExpanded.thirdPartyFire && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <span onClick={() => setIsTravelModalOpen(true)} className="w-[142px] h-[36px] bg-[#FF0226] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-white flex items-center justify-center mt-6">
                                                Insurance Features
                                            </span>
                                            <span className="w-[142px] h-[36px] bg-[#F7F7F8] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-black flex items-center justify-center mt-6">
                                                GET A QUOTE
                            ...
                            <div className="mb-4">
                                ...
                                {isExpanded.thirdPartyOnly && (
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <span onClick={() => setIsPartyModalOpen(true)} className="w-[142px] h-[36px] bg-[#FF0226] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-white flex items-center justify-center mt-6">
                                                Insurance Features
                                            </span>
                                            <span className="w-[142px] h-[36px] bg-[#F7F7F8] font-semibold text-[14px] leading-[20px] cursor-pointer shadow-md text-black flex items-center justify-center mt-6">
                                                GET A QUOTE
            ...
            <section>
                <div className="lg:p-20 p-4 small:p-10">
                    <div className="w-full lg:h-[450px] h-[700px]">
                        ...
                        <div className="flex lg:flex-row flex-col lg:gap-4 gap-8 lg:mt-4 mt-20">
                            <div className="flex-1 flex flex-col lg:h-[300px] w-[347px] gap-4 bg-white border-4 border-t-1 border-x-0 border-b-[#FF0226] rounded-lg shadow-md p-4">
